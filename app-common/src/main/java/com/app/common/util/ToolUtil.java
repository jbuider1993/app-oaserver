...
public class ToolUtil {
     ...
     */
    @SuppressWarnings("unchecked")
	public static Map<String, Object> findChildrenNote(Map<String, Object> treeNode, List<Map<String, Object>> treeNodes) {
    	List<Map<String, Object>> child = null;
        for (Map<String, Object> it : treeNodes) {
...
//			Thread.sleep(Constants.CPUTIME);
	 ...
	 * 发送信息给前端
	 */
	public static void sendMessageToPageComJson(HttpServletResponse response, Map<String, Object> bean, List<Map<String, Object>> beans){
		Map<String, Object> object = new HashMap<>();
		object.put("returnCode", 0);
		object.put("error", "0");
		object.put("returnMessage", "成功");
	 ...
	 * 发送信息给前端
	 */
	public static void sendMessageToPageComJson(HttpServletResponse response, Map<String, Object> bean, List<Map<String, Object>> beans, int total){
		Map<String, Object> object = new HashMap<>();
		object.put("returnCode", 0);
		object.put("error", "0");
		object.put("returnMessage", "成功");
	 ...
	 * 发送信息给前端
	 */
	public static void sendMessageToPageComJson(HttpServletResponse response, List<Map<String, Object>> beans, int total){
		Map<String, Object> object = new HashMap<>();
		object.put("returnCode", 0);
		object.put("error", "0");
		object.put("returnMessage", "成功");
